...
\KOMAoptions{headwidth=textwithmarginpar}
\automark[section]{chapter}
\lehead*{\pagemark\enskip\headmark}
\rohead*{\headmark\enskip\pagemark}
...
%% Sidenotes
\renewcommand*{\marginfont}{\tuftefont\footnotesize}
\DeclareCaptionFont{tuftefont}{\tuftefont}
\DeclareCaptionStyle{sidecaption}{font={footnotesize,tuftefont}}
\DeclareCaptionStyle{marginfigure}{font={footnotesize,tuftefont}}
\DeclareCaptionStyle{margintable}{font={footnotesize,tuftefont}}

%% Headings
\setkomafont{part}{\itshape\Huge\tuftefont}
...
% Tables
\hyphenation{aryloxy-propanolamine}
...
{\fontsize{22}{32}\selectfont
  \leftskip=1em
  \par\noindent
  \textcolor{darkgray}{\scshape{\tuftefont\@subtitle}}\par
}
      \vspace{22pc}
...
\AfterStartingTOC[toc]{\restoregeometry}
\DeclareTOCStyleEntry[linefill=\hfill]{tocline}{section}
\DeclareTOCStyleEntry[linefill=\hfill]{tocline}{subsection}
\DeclareTOCStyleEntry[linefill=\hfill]{tocline}{subsubsection}
