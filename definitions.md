...
A process which leads to an excess of hydrogen ions, and *may* lead to acidaemia if there is inadequate compensation. Can be subdivided into:
	...
	* **Metabolic acidosis**: HCO<sub>3</sub><sup>-</sup> < 22
...
A process which leads to a deficit of hydrogen ions, and *may* lead to alkalaemia if there is inadequate compensation. Can be subdivided into:
	* **Respiratory alkalosis**: PaCO<sub>2</sub> < 35
...
* **Base Excess**  
Amount of acid that must be added to a solution to lower its pH to 7.4, at 37°C and with a PaCO<sub>2</sub> of 40mmHg.
...
* **Bohr Effect**  
An increase in [H<sup>+</sup>] or PaCO<sub>2</sub> decreases Hb affinity for O2.
...
##D
* **Dalton**  
Unit of mass equal to 1/12<sup>th</sup> of the mass of Carbon-12.
...
* **Hypoxaemia**  
When PaO<sub>2</sub> is less than 60mmHg.
...
* **Pasteur Point**  
PO<sub>2</sub> at which oxidative phosphorylation ceases.
...
Ratio of CO<sub>2</sub> produced to O<sub>2</sub> consumed at steady-state.
...
The base excess calculated for an Hb of 5g.L<sup>-1</sup>, and which gives a better representation of ECF pH.
