  ...
  * **Pathological/Alveolar Dead Space**  \
  Dead space caused by disease. Causes of pathological dead space include:
    ...
    * Increased alveolar pressure\
    Increases West Zone 1^[Note that West Zone 1 (where PA > Pa > Pv) physiology is increased dead space.] physiology.
     * PEEP
    * COAD
...
Physiological dead space^[A **normal** value for physiological dead space during normal tidal breathing is **0.2-0.35**] is measured using the Bohr equation. This calculates dead space as a ratio, or as a proportion of tidal volume:

$${V_D \over V_T} = {V_T - V_A \over V_T}$$

The Bohr equation is based on the principle that **all CO~2~ exhaled must come from ventilated alveoli**^[The PaCO~2~-ETCO~2~ difference is a consequence of dead space, as dead space gas dilutes alveolar gas].
