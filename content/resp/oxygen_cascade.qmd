...
The **oxygen cascade** describes the **passive transfer** of oxygen down a series of **partial pressure gradient** from air to mitochondria:

::: column-margin
**Partial pressure** is the determinant of rate and extent of gas transfer, **but perfusion** depends on **oxygen content**
:::
...
:::column-margin
Essentially, $P_aO_2 \propto {k \over \dot{V}_A}$.

$k$ here is abstracting out the CO~2~ production, unit conversions, and the respiratory quotient. This also assumes steady state, and no A-a gradient.
:::
