...
Patient forcibly exhales a vital capacity breath, producing a exponential (wash-in) curve. This calculates:
    ...
    * FEV~1~ is the volume expired in 1s\
    ...
    * These values also quantify disease severity:
      ...
      * Restrictive disease:
        ...
        * FVC <80% predicted
        * FEV/FVC ratio >0.7\
        The ratio is normal as the FEV~1~ and FVC fall proportionally.
...
However, this reduction is **proportional** to the decrease in volume, such that the FEV~1~:FVC ratio is normal. If peak flow is preserved, the FEV~1~:FVC ratio will be increased.
