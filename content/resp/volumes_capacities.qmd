...
* ERV, V~T~, and IRV can all be measured directly using spirometry\
...
* Closing capacity is **lung volume at which small airways begin to close**\
...
Closing capacity is measured using Fowler's Method, and is covered under [Dead Space](dead_space.qmd).
