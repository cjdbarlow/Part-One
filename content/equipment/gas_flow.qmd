...
:::ANZCA
Describe the methods of measurement applicable to anaesthesia, including clinical utility, complications and sources of error in particular measurement of volumes, flows, and pressures~~, including transducers~~.
:::

:::ANZCA
Describe basic physics applicable to anaesthesia in particular behaviour of fluids (gases and liquids).
:::

Flow can be described the motion of the fluid as either:
...
* **Transitional** flow\
Mixture of laminar and turbulent flow. Transitional flow is typically turbulent in the centre, and laminar at the edges.
...
Also known as pneumotachographs.
* Hot wire flowmeter
...
\
$Q = {\Delta P r^4 \pi \over 8 \eta l}$, where:
