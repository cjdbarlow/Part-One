...
This section will focus on oxygen, covering:
...
Oxygen production can be performed using:
...
* Occurs in stages:
    * Filtration of atmospheric air\
    Removes dust and other contaminants.
    * **Compression** of filtered air to **6 atm**, followed by **cooling** to below ambient temperature\
    Water vapour condenses and is removed.
    * Cooled and compressed air passed through a **zeolite sieve** which removes CO~2~
    * Gas is then allowed to re-expand\
...
* Cheap
* Reliable
* Avoid need for oxygen delivery infrastructure
...
Methods for gas storage include:

* Gas cylinders\
Ideal for small quantities of a variety of different gases.
* Cylinder manifolds\
Efficient methods to provide piped supply of a variety of gases.
* Vacuum insulated evaporator\
Method to store large quantities of oxygen.
...
Pros of gas cylinders:

* Portable
* Reusable

Cons of gas cylinders:
...
Pros of cylinder manifolds:

* Cheap
* Useful as a backup supply

Cons of cylinder manifolds:
...
![Vacuum Insulated Evaporator](/resources/vie.svg)
