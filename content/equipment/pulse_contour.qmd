...
Less accurate but also less invasive (e.g. [thermodilution](cardiac_output.qmd#therm)) or technically demanding (e.g. [echocardiography](ultrasound.qmd#co)) than other methods.
	...
	Initial estimation is refined using a dilution technique.
		* Dilutions may be by:
			...
			* Lithium dilution
				...
				* CO by calculated [Stewart-Hamilton equation](cardiac_output.qmd#stew)
