...
:::column-margin
Pulse contour analysis is covered in detail under @sec-pulse_contour.
:::
...
* Remains the gold standard of cardiac output measurement
...
### Cardiac Output Measurement by Thermodilution {#stew}
...
* The temperature of blood is measured at the tip of the PAC\
...
Results in retrograde ejection of injectate back past the valve, resulting in a prolonged decay time of the thermodilution curve.
    * This *usually* results in **underestimation of CO**
    * May result in overestimation depending on the severity of regurgitation and the true CO
* Shunts\
...
Cardiac Output can also be measured using the **Fick Principle**, which **states** that the **blood flow to an organ** is **equal** to the **uptake of** a **tracer** substance **divided** by the **arterio-venous concentration difference** of tracer substance.

In this case:

* The tracer substance is oxygen
...
* Accurate measurement relies upon:
    * Mixed venous blood sampled from the pulmonary artery
    * Arterial blood sampled from a peripheral arterial line
