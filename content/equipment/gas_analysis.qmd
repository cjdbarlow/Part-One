...
As oxygen is a molecule containing two similar atoms, its partial pressure cannot be determined using infrared techniques (unlike CO~2~). Oxygen content of a gas is instead determined using either:
...
Used in many modern devices. In this method:
