...
![Tec 5 Plenum Vapouriser](/resources/tec5.svg)


### Comparison of Plenum and Draw-Over Vapourisers
...
![Tec 6 Vapouriser](/resources/tec6.svg)


## General Safety Features of Vapourisers

Safety features of vapourisers include:
...
* This leads to decreased flow through the vapourising chamber when FiO~2~ is low\
...
$Delivered \ Concentration \ (\%) = Intended \ Concentration \times {P_{cal} \over P_{alt}}$, where:
	* $Actual \ Delivered \ Concentration$ is the concentration of agent in the gas delivered to the patient\
	The actual delivered concentration must be multiplied by the atmospheric pressure to find the partial pressure of agent delivered to the patient.
