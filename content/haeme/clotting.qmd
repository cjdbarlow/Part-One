...
:::ANZCA
Describe the physiology of haemostasis, including coagulation and the role of platelets.
:::

Haemostasis describes the physiological processes that occur to stop bleeding. It involves three processes:

* **Vessel constriction**\
↓ Flow, which limits further haemorrhage and reduces the shear stresses which break up forming clot
...
* **Activation**\
Metabolic activation of the platelet to facilitate clotting.
    * Metabolic activation is stimulated by:
        * Collagen
        * Adrenaline
        * ADP
        * Thrombin 
    * Transforms the platelet from a disc to a sphere with long projections\
    Initiated by ↑ Phospholipase A~2~ and Phospholipase C, causing ↑ platelet intracellular Ca^2+^.
    * Activated platelets release ADP and thromboxane A~2~ from their **alpha granules** and **dense bodies**\
    This further amplifies platelet aggregation and adhesion.
* **Aggregation**\
...
The **coagulation cascade** is an amplification mechanism which activates clotting factors in order to produce fibrin. Participating factors in the coagulation cascade can be either **enzymes** or **cofactors**:
...
![The Clotting Cascade](/resources/coagulation_full.svg)

The clotting cascade is divided into the **intrinsic pathway** and **extrinsic pathway**, which join to form the **common pathway**.

:::column-margin
*In vitro*, the intrinsic and extrinsic pathways operate separately. This is an artifact of lab measurement - *in vivo* **the pathways are co-dependent**.
:::
...
* Tissue Factor\
Membrane protein on sub-endothelial cells, which is exposed when the vessel is damaged (it is found in a few other places as well). Tissue factor binds to factor VII to form VIIa, and thus activates the extrinsic pathway.
* Factor VII
...
The cascade model (above) accurately describes the process of clotting *in vitro*, but not *in vivo*. An alternative model, the cell-based model, offers an alternative perspective the emphasises the central role of the platelet:
