...
* **Activation**\
  Metabolic activation, increasing Phospholipase A~2~ and Phospholipase C, increasing platelet intracellular Ca^2+^ and initiating a transformation from a disc to a sphere with long projections.
    * Metabolic activation is stimulated by:
        * Collagen
        * Adrenaline
        * ADP
        * Thrombin 
    * Additionally, platelets release ADP and thromboxane A~2~ from their **alpha granules** and **dense bodies**, amplifying further platelet aggregation and adhesion
  \
  \
* **Aggregation**\
