...
: Effects of Sympathetic Nervous System Activation by Organ System
...
: Effects of Parasympathetic Nervous System Activation by Organ

+----------------+-------------------------------------------------------------------------+----------------------------------+
| Effector Organ |                       Parasympathetic Innervation                       |             Response             |
+================+=========================================================================+==================================+
| **CNS**        | CN III via the Edinger-Westphal nucleus                                 | Pupillary constriction (CN III)\ |
|                | CN VII                                                                  | Lacrimation (CN VII)\            |
+----------------+-------------------------------------------------------------------------+----------------------------------+
| **Lungs**      | CN X                                                                    | Bronchoconstriction\             |
+----------------+-------------------------------------------------------------------------+----------------------------------+
| **Heart**      | CN X                                                                    | ↓↓↓ Chronotropy\                 |
|                |                                                                         | ↓↓↓ Dromotropy\                  |
|                |                                                                         | ↓ Inotropy\                      |
|                |                                                                         | ↓ Lusitropy                      |
+----------------+-------------------------------------------------------------------------+----------------------------------+
| **GIT**        | CN VII (submaxillary and mandibular salivary glands)\                   | Salivation\                      |
|                | CN IX (parotid gland)\                                                  | ↓ Sphincter tone\                |
|                | CN X (stomach to proximal two-thirds of the transverse colon)\          | ↑ Motility                       |
|                | Hypogastric plexus (distal one-third of the transverse colon to rectum) |                                  |
+----------------+-------------------------------------------------------------------------+----------------------------------+
| **GU**         | Hypogastric plexus                                                      | Detrusor contraction             |
|                |                                                                         | Erection                         |
+----------------+-------------------------------------------------------------------------+----------------------------------+

::: column-margin
The decrease in inotropy and lusitropy from parasympathetic tone is greater in the atria than the ventricles.
:::
