...
![](/resources/ap-with-la.svg){fig-alt="Membrane potential over time showing a normal action potential, threshold potential and the response with local anaesthetic." width=100%}
...
Speed of onset is related to:
  * Drug factors
    ...
    * Lipid solubility\
    An ↑ lipid solubility:
      * ↑ The speed at which the local anaesthetic enters the nerve
