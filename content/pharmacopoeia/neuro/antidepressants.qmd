...
*Symptoms and management of TCA overdose is covered under [Tricyclic Antidepressant Overdose](../../tricyclic_antidepressant_overdose.qmd).*
...
+------------------------+--------------------------------------------------------------------------+--------------------------------------------------------------------------+------------------------------------------------+
| **Uses**               | Depression, treatment of chronic pain and trigeminal neuralgia           | Depression, anxiety                                                      | Treatment resistant depression. Now largely    |
|                        |                                                                          |                                                                          | superseded due to side-effect profile          |
+------------------------+--------------------------------------------------------------------------+--------------------------------------------------------------------------+------------------------------------------------+
| **Absorption**         | High PO bioavailability                                                  | High PO bioavailability                                                  |                                                |
+------------------------+--------------------------------------------------------------------------+--------------------------------------------------------------------------+------------------------------------------------+
| **Distribution**       | Highly lipid soluble with High V~D~. Very highly protein bound - leads   | Highly protein bound, high V~D~                                          |                                                |
|                        | to interactions with warfarin, digoxin, and aspirin                      |                                                                          |                                                |
+------------------------+--------------------------------------------------------------------------+--------------------------------------------------------------------------+------------------------------------------------+
...
| **Resp**               | Dry mouth                                                                |                                                                          |                                                |
+------------------------+--------------------------------------------------------------------------+--------------------------------------------------------------------------+------------------------------------------------+
| **CVS**                | Postural hypotension, ↑ HR.\                                             | Less cardiotoxic than TCAs, may precipitate serotonin syndrome           |                                                |
|                        | QT prolongation and widening QRS in overdose, with arrhythmia more       |                                                                          |                                                |
|                        | likely when QRS exceeds 0.16s.                                           |                                                                          |                                                |
+------------------------+--------------------------------------------------------------------------+--------------------------------------------------------------------------+------------------------------------------------+
| **CNS**                | Sedation, blurred vision, lowered seizure threshold. Excitation,         | Identical antidepressant effect to TCAs. Less sedation                   |                                                |
|                        | followed by seizures and depression in overdose.                         |                                                                          |                                                |
+------------------------+--------------------------------------------------------------------------+--------------------------------------------------------------------------+------------------------------------------------+
...
+------------------------+--------------------------------------------------------------------------+--------------------------------------------------------------------------+------------------------------------------------+
| **Other**              | Multiple complex drug interactions, including arrhythmias and variable   | Continue during perioperative period to avoid risk of discontinuation    |                                                |
|                        | BP with sympathomimetics, central anticholinergic syndrome, serotonin    | syndrome.                                                                |                                                |
...
DrugTable("amitriptyline", caption = "Tricyclic Antidepressants")
```

```{r}
DrugTable("fluoxetine", "venlafaxine", caption = "Serotonin-Reuptake Inhibitors")
```

```{r}
DrugTable("phenelzine", "isocarboxazid", "tranylcypromine", "moclobemide", "selegiline", caption = "Monoamine Oxidase Inhibitors")
```
