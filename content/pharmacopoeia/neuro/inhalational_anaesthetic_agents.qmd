...
MAC is not based on arterial partial pressure (F~a~) of agent. 
    * This is an important difference, because **even at steady-state**, **F~a~ ≠ F~A~**\
    * This occurs due to:
        * V/Q mismatch\
...
: Factors That Decrease and Increase MAC
...
A **low** blood:gas partition coefficient indicates a **rapid** onset and offset. This is because:
    ...
    * Conversely, soluble agents dissolve easily into pulmonary blood without substantially increasing P~a~\
    This causes leads to a slow onset due to:
        ...
        * A small gradient between P~a~ and P~B~
...
![](/resources/fa-fi.svg){fig-alt="Alveolar-to-inspired concentration ratio over time for nitrous oxide, desflurane, sevoflurane, isoflurane and halothane." width=100%}
...
Agents with a low blood:gas partition coefficient reach $\frac{F_A}{F_I}$ equilibrium more rapidly. The blood:gas coefficient is affected by:
    * Temperature\
...
![](/resources/fa-fao.svg){fig-alt="Alveolar concentration relative to its value at the start of washout, plotted against time." width=100%}
...
* Chemical structures of different volatile anaesthetics are covered in the [pharmacopeia](inhalational_anaesthetics.qmd).
