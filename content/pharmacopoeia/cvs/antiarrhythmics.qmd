...
DrugTable("procainamide", "lignocaine", "phenytoin", "flecainide", "mexiletine", caption = "Class I Antiarrhythmics")
```
...
```{r}
DrugTable("esmolol", "metoprolol", "atenolol", "propranolol", caption = "Class II Antiarrhythmics")
```
...
```{r}
DrugTable("amiodarone", "sotalol", caption = "Class III Antiarrhythmics")
```
...
```{r}
DrugTable("verapamil", "diltiazem", caption = "Class IV Antiarrhythmics")
```
...
: Alternative Antiarrhythmic Selection by Indication
...
```{r}
DrugTable("digoxin", "adenosine", "magnesium_sulfate", caption = "Non-Vaughan Williams Antiarrhythmics")
```
...
2. Brunton LL, Chabner BA, Knollmann BC, eds. Goodman & Gilman's The Pharmacological Basis of Therapeutics. 12th Ed. McGraw-Hill. 2011.
