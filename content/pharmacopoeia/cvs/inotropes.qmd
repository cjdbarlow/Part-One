...
: Classification of Positive Inotropes
...
Detailed profiles of the adrenergic and non-adrenergic vasoactives are provided on the [Adrenergic Vasoactives](adrenergic_drugs.qmd) and [Non-Adrenergic Vasoactives](../resp/non_adrenergic_drugs.qmd) pages.

```{r}
source("scripts/drugtables.R")

DrugTable("glucagon", "triiodothyronine", caption = "Other Positive Inotropes")
```
