...
Resistance occurs when the **maximal level** of the agent tolerated is **insufficient** to **inhibit growth**, and may be produced by two broad mechanisms:
...
* **Protein Expression**\
↑ Or ↓ expression of proteins with subsequent change in efficacy of antimicrobials.
...
Can occur via:
    ...
    * Active efflux of agent\
    ↑ Efficiency or expression of efflux pumps. This results in the antimicrobial agent being:
        * Removed from cell
