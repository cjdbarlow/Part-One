...
This formula demonstrates that **GFR is inversely proportional to serum creatinine** concentration^[The relationship between GFR and creatinine concentration only holds when both creatinine production and glomerular filtration are at steady-state. A **sudden drop in glomerular filtration** (e.g. aortic cross-clamp) **will not** result in an **immediate rise in creatinine** concentration.\
\
During acute reductions in GFR, serum creatinine will underestimate GFR until a new steady state is reached.]
