...
* Extract only **10% of delivered O~2~**
...
**Renin**^[The actions of the RAAS are described in more detail in the [endocrine functions of the kidney](endocrine_functions_of_the_kidney.md#raas).]:

* Is released from the juxtaglomerular apparatus by β~1~ stimulation
