...
+-------------------------+---------------------+---------------------+----------------+
| Amylase                 | Gastrin             | Digestive proteins: | Somatostatin   |
+-------------------------+---------------------+---------------------+----------------+
| Lipase                  | Pepsin              | Lipase              |                |
+-------------------------+---------------------+---------------------+                |
| Mucin                   | Intrinsic Factor    | Amylase             |                |
+-------------------------+---------------------+---------------------+                |
| Haptocorrin\            | Mucosal protection: | Trypsinogen         |                |
| Binds Vitamin B12.      |                     |                     |                |
+-------------------------+---------------------+---------------------+                |
| Immunological proteins: | Mucous              |                     |                |
+-------------------------+---------------------+                     |                |
| Lysozyme                | HCO~3~^-^           |                     |                |
+-------------------------+---------------------+                     |                |
| Lactoferrin             |                     |                     |                |
