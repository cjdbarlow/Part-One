...
|Direct effects|<p>↓ L-Ca^2+^ activity</p><p>↑ NO activity</p>|<p>Minimal</p><p>Some negative inotropy</p>|
...
|CNS circulation|Dose-dependent|<p>↑ CMRO~2~ → CBF</p><p>Avoid if ↑ ICP</p>|
...
|Sevoflurane|Detail|
| -- | -- |
|CBF|<p>- ≤0.5MAC: ↓ CBF (↓ CMRO~2~ predominates)</p><p>- 0.5-1MAC: CBF normalises</p><p>- >1MAC: ↑ CBF (vasodilatation predominates)</p>|
|Preconditioning|<p>- Activation of mitochondrial and sarcolemmal ATP-sensitive K^+^ channels → Hyperpolarization</p><p>- Occurs at MAC >0.25</p><p>- Mimics ischaemic preconditioning</p>|
