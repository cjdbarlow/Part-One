...
|Perfusion|<p>- Gravity → West’s zones:</p><p>1. PA > Pa > Pv: No flow (apex)</p><p>2. Pa > PA > Pv: Flow in systole (from 3cm above RV to apex)</p><p>3. Pa > Pv > PA: Flow throughout (from base to 3cm above RV)</p><p>- Hypoxic pulmonary vasoconstriction:</p><p>&emsp;- ↓ Ventilation → ↓ PO~2~ in individual alveolus → Vasoconstriction</p><p>&emsp;- Improves local V/Q matching</p>|
|Carbon dioxide|<p>- CO~2~ flux fairly evenly distributed</p><p>&emsp;- Mild gradient in ventilation from base to apex</p><p>&emsp;- Effective compensation for ↓ V/Q regions</p><p>&emsp;- Hyperventilation → ↓↓ CO~2~ in well-matched regions</p><p>&emsp;- High CO~2~ solubility → PaCO~2~/CaCO~2~ curve is steep</p><p>→ V/Q inequality rarely causes hypercapnoea</p>|
|Oxygen|<p>- O~2~ flux almost all near the base</p><p>&emsp;- Steep gradient in perfusion from base to apex</p><p>&emsp;- Ineffective compensation for ↑ V/Q regions</p><p>&emsp;- Hyperventilation → ↔↑ O~2~ in well-matched regions</p><p>&emsp;- Low O~2~ solubility + finite Hb binding sites → OHDC upper part flat</p><p>→ V/Q inequality often causes hypoxaemia</p>|
