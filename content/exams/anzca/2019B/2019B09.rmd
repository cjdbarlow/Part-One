...
|↑ Diffusion Coefficient|<p>- ↑ % Unionised: (major factor)</p><p>&emsp;- Drug: Ligno 25% cf. ropiv 15%</p><p>&emsp;- Additive: e.g. HCO~3~^-^ → ↑ % unionised</p><p>&emsp;- Patient: e.g. Abscess → Acidosis → ↓↓ % unionised</p><p>- ↑ Lipid solubility (ropiv 300x cf. ligno 150x)</p><p>- ↓ Molecular weight (ligno 234g.mol^-1^ cf. bupiv 274g.mol^-1^)</p>|
