...
|↑ Diffusion coeff|<p>- ↑ % Unionised (most important factor):</p><p>&emsp;- Drug: e.g. Prilocaine 33% cf. bupivacaine 15%</p><p>&emsp;- Additive: e.g. HCO~3~^-^ → ↑ % Unionised</p><p>&emsp;- Patient: e.g. Abscess → Acidosis → ↓↓ % Unionised</p><p>- ↑ Lipid solubility (e.g. Bupiv 1000x cf. lignocaine 150x)</p><p>- ↓ Molecular weight</p>|
