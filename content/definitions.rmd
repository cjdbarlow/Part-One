...
A process which leads to an excess of hydrogen ions, and *may* lead to acidaemia if there is inadequate compensation. Can be subdivided into:
	* **Respiratory acidosis**: PaCO~2~ > 45
	* **Metabolic acidosis**: HCO~3~^-^ < 22
...
A process which leads to a deficit of hydrogen ions, and *may* lead to alkalaemia if there is inadequate compensation. Can be subdivided into:
	* **Respiratory alkalosis**: PaCO~2~ < 35
	* **Metabolic alkalosis**: HCO~3~^-^ > 26
...
* **Base Excess**\
Amount of acid that must be added to a solution to lower its pH to 7.4, at 37°C and with a PaCO~2~ of 40mmHg.
...
* **Bohr Effect**\
An increase in [H^+^] or PaCO~2~ decreases Hb affinity for O2.
...
* **Dalton**\
Unit of mass equal to 1/12^th^ of the mass of Carbon-12.
...
* **Diffusion Hypoxia**\
Fall in alveolar PAO~2~ due to dilution of alveolar gas by N~2~O diffusing from blood to alveoli.
...
* **Hypoxaemia**\
When PaO~2~ is less than 60mmHg.
...
* **Pasteur Point**\
PO~2~ at which oxidative phosphorylation ceases.
...
Ratio of CO~2~ produced to O~2~ consumed at any given point.

* **Respiratory Quotient**\
Ratio of CO~2~ produced to O~2~ consumed at steady-state.
