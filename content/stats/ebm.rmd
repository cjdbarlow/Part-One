...
# (EMPTY) Research Methods and Statistics
...
The NHMRC^[Other organisations and institutions have different grading systems, most are broadly similar.] defines 6 levels of evidence, graded from I-IV:
...
* Level IV is evidence from a case-series^[Note that expert opinion is **not** part of NHMRC levels of evidence, though it is included on the Oxford Centre for Evidence Based Medicine system, used by the NHS.]
