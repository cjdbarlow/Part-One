...
* Is used when:
    ...
    * When it statistically appropriate^[ORs are much easier to use in many statistical tests than RR because the log-odds ratio is normally distributed - a mathematically useful property - and so tend to be favoured by statisticians.]
