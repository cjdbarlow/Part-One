...
## Error, Sensitivity, Specificity, and Predictive Values

:::info
All of these terms refer to characteristics of **diagnostic tests**. The easiest way to approach this is via a 2x2 table, and has been recommended in previous exams as an approach to questions on this topic.
:::

: Components of a 2×2 table

+-------------------+-----------------------+-----------------------+--------------------+
| Result            | Disease  Positive     | Disease Negative      | Total              |
+===================+=======================+=======================+====================+
...
+-------------------+-----------------------+-----------------------+--------------------+
| **Total**         | All Disease Positives | All Disease Negatives | Total              |
+-------------------+-----------------------+-----------------------+--------------------+
...
From the table, we can see that there can be both false positive and false negative results:
...
* Refers to the ability of a test to **detect the condition**
...
* Refers to the ability of a test to **detect *absence* of the condition**\
...
: Relationships Between Diagnostic-Test Results and Derived Measures

+-------------------+-------------------+------------------+------------------+
|    Test Result    | Disease  Positive | Disease Negative | Derived Variable |
+===================+===================+==================+==================+
