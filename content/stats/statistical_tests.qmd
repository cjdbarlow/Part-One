...
This is a variant of the Z test, used when the population standard deviation is not known^[The results from Student's T test approximate the results of the Z test when n > 100].
