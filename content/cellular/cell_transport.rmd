...
The Gibbs-Donnan Effect describes the **tendency of permeable ions** to **distribute** themselves **such that the *ratios* of** the **concentrations are equal** when they are **in** the **presence of non-diffusable ions**^[Remember: all ions are charged.].
