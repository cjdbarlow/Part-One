...
Pressure-volume loops are a graphical representation of the relationship between pressure and volume over the cardiac cycle. Time is **not** *directly* demonstrated, but the stages of the cardiac cycle can be inferred.

The **Left Ventricular P-V Loop** is the standard introduction to the topic:

<img src="/resources/lv-pv-loop.svg">

* Stages of the cardiac cycle are indicated by the following intervals:
	...
	* C-D is isovolumetric contraction\
	The ventricle contracts. As ventricular pressure is greater than atrial pressure but less than aortic pressure, the mitral valve closes (point C) and the aortic valve remains closed. Pressure increases without a change in volume.
		* This slope of this line is known as the **dP/dt~max~** ($\Delta P \over \Delta T$), and is an index of [contractility](determinants_of_cardiac_output.md#cont)
