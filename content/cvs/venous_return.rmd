...
^[This section describes determinants of cardiac output from the perspective of venous return. The relationship to and importance of [myocardial function](determinants_of_cardiac_output.md) is covered elsewhere.]Venous return is the rate at which blood is returned to the heart (in L.min^-1^). **At steady state**, venous return is equal to cardiac output, and can be expressed as $VR = {MSFP - RAP \over RVR}$, where:
