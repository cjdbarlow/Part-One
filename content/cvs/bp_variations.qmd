...
::: column-margin
This recoil is known as the **Windkessel effect**.
:::

* A **blood flow wave**\
Travels at **~20cm.s^-1^**.
* An **arterial pressure wave**\
Distends the elastic walls of the large arteries during systole, which then recoil during diastole to facilitate continual blood flow.
...
::: column-margin
Note that this does not necessarily mean a fluid responsive patient needs fluid, or that fluid will not be harmful.
:::
