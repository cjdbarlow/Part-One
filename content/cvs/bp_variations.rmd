...
Distends the elastic walls of the large arteries during systole, which then recoil during diastole to facilitate continual blood flow^[This recoil is known as the **Windkessel effect**.].
...
* Mathematically defined as $PPV = {PP_{max} - PP_{min} \over PP_{mean}} \times 100$, where:
    * $PPV$ is pulse pressure variation
...
* Used as an indicator of **fluid responsiveness**\
    ...
    * A PPV of **>12%** suggests volume responsiveness^[Note that this does not necessarily mean a fluid responsive patient needs fluid, or that fluid will not be harmful.]
