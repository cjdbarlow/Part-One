...
::: column-margin
The proximal LAD is defined as the area of LAD between the origin and D~1~, mid LAD is between D~1~ and D~2~, etc.
:::
...
* **Branches** of the LAD include:
    * **Diagonal** vessels\
    Branches are named successively from proximal to distal (i.e. LADD~1~, LADD~2~, etc), and wrap around the anterior wall of the ventricle.
    * **Septal perforators**\
...
::: column-margin
Acute marginal arteries are almost never grafted.
:::
