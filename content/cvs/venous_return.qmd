# Venous Return {#sec-venousreturn}
...
* C**onduit for return** of blood to the heart

::: column-margin
This section describes determinants of cardiac output from the perspective of venous return. The relationship to and importance of the determinants of cardiac output is covered in @sec-cardiacoutputdeterminants: Determinants of Cardiac Output.
:::

Venous return is the rate at which blood is returned to the heart (in L.min^-1^). **At steady state**, venous return is equal to cardiac output, and can be expressed as $VR = {MSFP - RAP \over RVR}$, where:
...
Other factors affecting venous return include:
