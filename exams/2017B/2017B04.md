...
|Algorithm|<p>1. Burst-suppression ratio (correlates with BIS 0-30)</p><p>- % per 63 seconds spent in burst-suppression pattern (not isoelectricity)</p><p>- Associated with depletion of intracellular calcium</p><p>2. QUAZI suppression index</p><p>- Detect burst suppression if wandering baseline</p><p>3. SynchFastSlow index (correlates with BIS 40-60)</p><p>- Index of relative synchrony of fast and slow waves</p><p>- Derived from bispectral analysis</p><p>- Processed to yield bicoherence number (0-1 scale of phase coupling)</p><p>- N.B. PowerFastSlow yields similar results</p><p>4. Beta ratio (correlates BIS 60-100)</p><p>- Ratio of higher to lower frequency beta waves</p><p>- Important due to paradoxical increase in SFS/SEF at low drug concentration</p><p>5. EMG</p><p>- Frontalis muscle activity</p><p>- High frequency (70-110Hz)</p><p>- ? Indicator of nociception or arousal</p>|
| -- | -- |
