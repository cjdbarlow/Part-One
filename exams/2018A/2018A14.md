...
| -- | -- |
|Reduce loss|<p>- Vasoconstriction → ↓ Skin temp (↓ T<sub>1</sub>) (impaired under GA)</p><p>- Insulation e.g. Blanket</p><p>- Pre-warming of operating theatre (↑ T<sub>2</sub>)</p>|
...
| -- | -- |
|Reduce loss|<p>- Vasoconstriction → ↓ Skin temp (T<sub>1</sub>) (impaired under GA)</p><p>- Insulation e.g. Blanket traps a layer of air next to patient</p>|
...
| -- | -- |
|Reduce loss|<p>- Heat and moisture exchanger (HME)</p><p>&emsp;- Expired air cooled by HME, water vapour condenses</p><p>&emsp;- Inspired air warmed by HME, water evaporates</p><p>&emsp;- Extends gradients for temp and humidity: Lung > HME > circuit</p><p>&emsp;- Hence extends countercurrent heat and moisture exchange</p><p>- CO<sub>2</sub> absorber:</p><p>&emsp;- CO<sub>2</sub> + sodalime reactions produce heat and water</p><p>&emsp;- Hence ↓ temperature gradient, ↓ humidity gradient</p><p>&emsp;- Hence ↓ latent heat loss</p>|
...
| -- | -- |
|Reduce loss|<p>- Vasoconstriction → ↓ Skin temp (T<sub>1</sub>) (impaired under GA)</p><p>- Heated OT table → Reverse temp gradient</p><p>- Insulated material on table → ↓ Thermal conductivity</p>|
